...
class observer {
    ...
    public static function quiz_override_created(user_override_updated $event) : void {
        global $DB;
        ...
        $validation = array(
            ...
            'userid' => $event->relateduserid //empty($event->relateduserid)? null : $event->relateduserid,
